...
namespace SoftBody
{
    public class Model : MonoBehaviour
    {
        ...
        void Movement()
        {
            if (body.velocity.magnitude < 0.25f || unit.unitState == UnitState.Fighting ||unit.unitState == UnitState.Idle)
